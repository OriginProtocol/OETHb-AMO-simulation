...
with open("data/Simulation3B.json", "r") as file:
    data = json.load(file)
...
fig.suptitle("Simulation 3B Results", fontsize=16, fontweight="bold")
...
plt.savefig("data/graphs/Simulation3B.png", dpi=300, bbox_inches="tight")
print("Simulation 3B graph saved successfully!")
