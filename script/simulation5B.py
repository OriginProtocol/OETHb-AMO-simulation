...
with open("data/Simulation5B.json", "r") as file:
    data = json.load(file)
...
fig.suptitle("Simulation 5B Results", fontsize=16, fontweight="bold")
...
plt.savefig("data/graphs/Simulation5B.png", dpi=300, bbox_inches="tight")
print("Simulation 5B graph saved successfully!")
